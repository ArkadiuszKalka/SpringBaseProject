    ...
    <script type="text/javascript">
        ...
        function startSearch() {
            ...
            if (searchWord.length < 3) {
                ...
                var searchLink = '${pageContext.request.contextPath}/admin/user/search' + searchWord;
...
<div align="center">
    <div align="right" style="width:1000px;padding: 2px;">
        ...
        &nbsp;&nbsp;
        <input type="button" value="<s:message code="button.search"/>" onclick="startSearch();"/><br/>
